...
#to examine how musical characteristics vary over time.
  ...
  ggplot(yearly, aes(x=year, y=mean_danceability)) +
    geom_line() +
    labs(title="Average Danceability of Billboard Top 100 Songs (2000-2021)",
         x="Year",
         y="Mean Danceability")
ggplot(yearly, aes(x=year, y=mean_energy)) +
  geom_line() +
  labs(
    title="Average Energy of Billboard Top 100 Songs (2000-2021)",
    x="year",
    y="Mean Energy")
ggplot(yearly, aes(x=year, y=mean_valence)) +
  geom_line() +
  labs(
    title="Average Valence of Billboard Top 100 Songs (2000-2021)",
    x="Year",
    y="Mean Valence")
